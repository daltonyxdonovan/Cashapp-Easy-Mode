...
cal_export = pyautogui.locateOnScreen('export_cal.png', confidence = 0.7)
cal_statement = pyautogui.locateOnScreen('statements_cal.png', confidence = 0.7)
cal_login = pyautogui.locateOnScreen('login_cal.png', confidence = 0.7)
def update_script():
    if dals == True:
        time.sleep(5)
